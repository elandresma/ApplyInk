...
namespace ApplyInk.Common.Services
{
    public class ApiService : IApiService
    {
        ...
        public async Task<Response> GetListShop<T>(string urlBase,string servicePrefix, string controller)
        {
            try
            {
                HttpClient client = new HttpClient
        ...
        public async Task<Response> GetMyMeetingsAsync<T>(
       string urlBase,
       string servicePrefix,
       string controller, MeetingRequest email)
        {
            try
            {
